<div class="container-fluid">
    ...
    <div class="container">
        ...
        <li>
            ...
            <li><img src="<?php echo __URL?>Library/StucoMembers/Preston.png"></li>
            <li><img src="<?php echo __URL?>Library/StucoMembers/Matthew.png"></li>
            <li><img src="<?php echo __URL?>Library/StucoMembers/Louis.png"></li>
            <li><img src="<?php echo __URL?>Library/StucoMembers/Jack.png"></li>
            <li><img src="<?php echo __URL?>Library/StucoMembers/Anthony.png"></li>
            </ul>
        </div>
