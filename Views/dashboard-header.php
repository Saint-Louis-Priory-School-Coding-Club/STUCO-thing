...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="/user/dashboard">Priory Dashboard</a>
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/user/dashboard/pages">
            <i class="fas fa-fw fa-file"></i>
            <span>Pages</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/user/dashboard/stuco">
            <i class="fas fa-fw fa-book-reader"></i>
            <span>Stuco Members</span></a>
        </li>
      </ul>