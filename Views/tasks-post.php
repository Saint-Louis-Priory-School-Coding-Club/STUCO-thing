...
$id = $_SESSION['postId'];
$posts = $conn->query("SELECT * FROM ctask WHERE id =$id");
$numrows = $posts->num_rows;
if ($numrows < 1) {
    $viewer = new View;
    $viewer->e4041('Task Not Found');
    die();
}
...
if (isset($_POST["delete"])) {
    $sql = $conn->query("DELETE FROM ctask WHERE id =$id");
    echo '<meta http-equiv="Refresh" content="0; url=/tasks">';
}
        ...
        <div class="container-fluid">
          ...
          <h1><?php echo $post['title']; ?></h1>
            ...
            <div class="panel panel-default container">
                ...
                <div class="container">
                <?php
                $paginate->paginate($conn, 'tcomments', 5, $id);
                ?>
                </div>
                <h2>Add Comment:</h2>
                <?php 
