...
<html lang="en">
    ...
    <div class="container-fluid"> <!--full body page-->
        ...
        <div class="post rounded" id="post-0" post-id=213534>
            ...
            <div class="post-body-container"><p class="post-body">hello i am a user hello i am a user hello i am a user hello i am a user hello i am a user hello i am a user hello i am a user hello i am a user hello i am a user hello i am a user hello i am a user hello i am a user hello i am a user hello i am a user hello i am a user hello i am a usesjadhvoaudshgcinuehgiadhsinudhsfgjklhdflkjghskljfsdhglkjsdfhdfhr hello i am a user hello i am a user hello i am a user hello i am a user hello i am a user hello i am a user hellooo00007967857856846865<p>
            <button type="button" class="btn btn-dark read-more">Show More</button>
            <p class="show-more-txt">text lol</p>
            </div>
            <div class="post-options row noselect">
                <div class="vote col-sm-4"><div class="upvoted square rounded"><i class="fas fa-arrow-up"></i></div> <span class="vote-number">2</span> <div class="downvote square rounded"><i class="fas fa-arrow-down"></i></div></div>
                <div class="comments col-sm-4"><i class="far fa-comments"></i> <span class="comment-number">43</span> comments</div>
                <div class="report col-sm-4"><i class="far fa-flag"></i> Report</div>
            </div>
        </div>
       	...
       	<div class="post rounded" id="post-1" post-id=61346>
            ...
            <div class="post-options row noselect">
                <div class="vote col-sm-4"><div class="upvote square rounded"><i class="fas fa-arrow-up"></i></div> <span class="vote-number">-2</span> <div class="downvoted square rounded"><i class="fas fa-arrow-down"></i></div></div>
                <div class="comments col-sm-4"><i class="far fa-comments"></i> <span class="comment-number">7</span> comments</div>
                <div class="report col-sm-4"><i class="far fa-flag"></i> Report</div>
            </div>
        </div>
        ...
        <div class="post rounded" id="post-2" post-id=01240>
        	<div class="row">
            <div class="col-sm-8"><h1><div class="verifycheck square circle"><i class="fas fa-check"></i></div> tespacito <span class="badge badge-secondary">Poll</span></h1></div><div class="col-sm-4 date"><h5>2m ago</h5></div></div>
            <h2>by Mr. STUCO Member <div class="verifycheck square circle"><i class="fas fa-check"></i></div></h2>
            <p class="post-body">is despaito just grand</p>
            <div class="post-options row noselect">
                <div class="vote col-sm-4"><div class="votechecked square rounded"><i class="fas fa-check"></i></div> <span class="vote-number">432</span> <div class="votex square rounded"><i class="fas fa-times"></i></div> <span class="x-number">1</span></div>
                <div class="comments col-sm-4"><i class="far fa-comments"></i> <span class="comment-number">723</span> comments</div>
                <div class="report col-sm-4"><i class="far fa-flag"></i> Report</div>
            </div>
        </div>
            ...
            <div class="post-options row noselect">
                <div class="vote col-sm-4"><div class="votecheck square rounded"><i class="fas fa-check"></i></div> <span class="vote-number">12</span> <div class="votexed square rounded"><i class="fas fa-times"></i></div> <span class="x-number">2</span></div>
                <div class="comments col-sm-4"><i class="far fa-comments"></i> <span class="comment-number">0</span> comments</div>
                <div class="report col-sm-4"><i class="far fa-flag"></i> Report</div>
            </div>
        </div>
        ...
        <script>
            ...
            $('.post-body-container').each(function() {  // for each .post-body
            	postbody = $(this).children(".post-body")[0];
                alert(postbody);
                alert(postbody.html());
            	leng = postbody.text().length;
                alert(leng);
                if (leng > 400) { // if more than 400 characters
                	alert(postbody.text().slice(0, 400));
                    alert(postbody.text().slice(400, leng));
                }
            });
        </script>
        </div>
