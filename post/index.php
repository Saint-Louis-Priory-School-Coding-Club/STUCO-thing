...
-->
    ...
    <div class="container-fluid">
        ...
        <div class="post rounded" post-id=65>
            ...
            <div class="attachment" id="attachment">http://hexbugman213.net/files/TikTok%20PSA.mp4</div>
            <div class="post-options row noselect">
                <div class="vote col-4">
                    <div class="uv-button upvoted square rounded" style="width: 30px;"><i class="fas fa-arrow-up"></i></div> <span class="vote-number">2</span>
                    <div class="dv-button downvote square rounded" style="width: 30px;"><i class="fas fa-arrow-down"></i></div>
                </div>
                <div class="comments col-4">
                    <a href="#comments" class="noastyle">
                        <div class="comment-c"><i class="far fa-comments"></i> <span class="comment-number">6</span> <span class="c-name">comments</span></div>
                    </a>
                </div>
            ...
            <div class="comment" comment-id=27172>
                ...
                <div class="comment-replies">
                    <div class="comment" comment-id=1234>
                        ...
                        <div class="comment-options">
                            <div class="uv-button upvoted square rounded" style="width: 20px;"><i class="fas fa-arrow-up"></i></div> <span class="vote-number">1.2k</span>
                            <div class="dv-button downvote square rounded" style="width: 20px;"><i class="fas fa-arrow-down"></i></div>
                        </div>
                        <div class="comment-replies">
                            <div class="comment" comment-id=12213>
                                ...
                                <div class="comment-options">
                                    <div class="uv-button upvoted square rounded" style="width: 20px;"><i class="fas fa-arrow-up"></i></div> <span class="vote-number">174k</span>
                                    <div class="dv-button downvote square rounded" style="width: 20px;"><i class="fas fa-arrow-down"></i></div>
                                </div>
                                <div class="comment-replies">
                    ...
                    <div class="comment" comment-id=4321>
                        ...
                        <div class="comment-options">
                            <div class="uv-button upvoted square rounded" style="width: 20px;"><i class="fas fa-arrow-up"></i></div> <span class="vote-number">5</span>
                            <div class="dv-button downvote square rounded" style="width: 20px;"><i class="fas fa-arrow-down"></i></div>
                        </div>
                        <div class="comment-replies">
                            <div class="comment" comment-id=12213>
                                ...
                                <div class="comment-options">
                                    <div class="uv-button upvoted square rounded" style="width: 20px;"><i class="fas fa-arrow-up"></i></div> <span class="vote-number">3</span>
                                    <div class="dv-button downvote square rounded" style="width: 20px;"><i class="fas fa-arrow-down"></i></div>
                                </div>
                                <div class="comment-replies">
            ...
            <div class="comment" comment-id=27172>
                ...
                <div class="comment-body-container">
                    <p class="comment-body"></p>
                </div>
                <div class="comment-options">
                    <div class="uv-button upvote square rounded" style="width: 20px;"><i class="fas fa-arrow-up"></i></div> <span class="vote-number">34</span>
                    <div class="dv-button downvote square rounded" style="width: 20px;"><i class="fas fa-arrow-down"></i></div>
                </div>
                <div class="comment-replies">
