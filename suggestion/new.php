...
-->
    ...
    <div class="container-fluid" ng-app="">
        ...
        <div class="container-box rounded">
            ...
            <form action="/action_page.php" method="POST" class="">
                ...
                <div class="form-group row">
                    ...
                    <small id="fileHelp" class="form-text text-muted"><span data-toggle="tooltip" data-html="true" title="File uploading is not supported <em>yet</em>. Upload your file to a service like Dropbox or Imgur and paste the direct link here. The direct link will end with the file extention. Example: <span style='color:#ddd;'>http://hexbugman213.net/favicon.png</span>">An optional attachment to be shown below your post. Hover or tap for info.</span></small>
                </div>
                <div class="form-group row">
        ...
        <div class="post container-box rounded">
            <h1>Post Preview:</h1></div>
        <div class="post container-box rounded">
